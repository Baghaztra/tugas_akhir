<template>
  <Teleport to="body">
    <div v-if="open" class="fixed inset-0 z-50 bg-white flex flex-col">
      ...
      <!-- Canvas -->
      <div ref="canvasWrapEl" class="flex-1 min-h-0 overflow-hidden">
...
const resizeCanvas = () => {
  ...
  const { width, height } = canvasWrapEl.value.getBoundingClientRect()
...
const onResize = () => { if (props.open) resizeCanvas() }
